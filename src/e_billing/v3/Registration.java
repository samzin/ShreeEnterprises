...
public class Registration extends javax.swing.JFrame {
    ...
    public Registration(String Role, String Username) {
        initComponents();
        getDatabase_Connections();
        role = Role;
        username = Username;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnSettings, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        lblPasserror.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lblPasserror.setForeground(new java.awt.Color(255, 51, 51));

        lblUsernameerror.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lblUsernameerror.setForeground(new java.awt.Color(255, 51, 51));

        txtPass1.setBackground(new java.awt.Color(240, 240, 240));
        txtPass1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N

        cmbRole1.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        cmbRole1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "*****", "Admin", "user" }));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(351, 351, 351)
                                .addComponent(lblUser, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblUsernameerror, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel4Layout.createSequentialGroup()
                                    .addComponent(txtPass1, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(lblRole, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel4Layout.createSequentialGroup()
                                    .addComponent(txtPass, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(lblPasserror, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbRole1, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(178, 178, 178)))
                .addGap(329, 329, 329))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(168, 168, 168)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblUsernameerror, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblPasserror, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jTabbedPane1.addTab("New User Registration", jPanel6);
        ...
        jLabel4.setText("Contact - 7709013826");
...
//        Main_Form s = new Main_Form(role, username);
//        s.setVisible(true);
//        this.dispose();
    ...
    private void txtUsernameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUsernameKeyReleased
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select Username from tabLogininfo where Username = '" + username + "'");
            if (rs.next()) {
                lblUsernameerror.setText("Already Registered User..");
            } else {
                lblUsernameerror.setText("");
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(rootPane, e + "@ Userkeypress");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String re_pass = txtPass1.getText();

      
        int indx1 = cmbRole1.getSelectedIndex();
        String role1 = cmbRole1.getSelectedItem().toString();
        try {
            if (username.equals("")) {
                ...
                lblUsernameerror.setText("");
                lblPasserror.setText("Enter Password..");
            }  else {
                Database db = new Database();
                com.mysql.jdbc.Connection con = (com.mysql.jdbc.Connection) db.conn();
                Statement st = (Statement) con.createStatement();
                ResultSet rs = st.executeQuery("SELECT Username FROM tabLogininfo where Username='" + username + "'");
                if (rs.next()) {
                    lblUsernameerror.setText("Please Enter other Username..");
                } else {
                    if (txtPass.getText().equals(txtPass1.getText())) {
                        st.executeUpdate("insert into tabLogininfo(Username,Pass,Role) values('" + username + "','" + password + "','" + role1 + "')");
                        ...
                        lblPasserror.setText("Not Same Password..");
                    }
                }
            }

        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Error! Click Reset....");
        }
        //      showUsers();
